...
export const downloadPdf = () => {
    ...
    store.data.forEach((v) => {
      r.push(
        [
          ...
          v["M"]["N80"],
          v["M"]["RB80"],
          { text: v["M"]["GB80"], style: "lineThrough" },
          v["M"]["A84"],
          v["M"]["N84"],
          v["M"]["RB84"],
          { text: v["M"]["GB84"], style: "lineThrough" },
          "/",
          v["E"]["A"],
          v["E"]["N"],
          v["E"]["AN"],
          ...
          v["E"]["N80"],
          v["E"]["RB80"],
          { text: v["E"]["GB80"], style: "lineThrough" },
          v["E"]["A84"],
          v["E"]["N84"],
          v["E"]["RB84"],
          { text: v["E"]["GB84"], style: "lineThrough" },
          "/",
          v["lost"]["1080"],
          v["lost"]["1084"],
        ].reverse()
  ...
  pdfMake.createPdf(docDefinition).download(`${date1} ${day1}_list`);
