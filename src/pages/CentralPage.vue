    ...
    <div v-if="store.data[0]" class="row justify-evenly">
      ...
      <div class="col-12 q-pt-lg">
        <div class="row justify-center q-gutter-md">
          <div class="col-auto">
            [ مفقود80: {{ store.data[0].lost["1080"] }} ]
          </div>
          <div class="col-auto">
            [ مفقود84: {{ store.data[0].lost["1084"] }} ]
          </div>
        </div>
      </div>
      <PdfButtons :doc-i="docI" />
      <div class="q-pa-md">
        <div id="radio" class="q-gutter-sm">
          <q-radio v-model="docI" val="0" label="تقرير" />
          <q-radio v-model="docI" val="1" label="خطاب" />
        </div>
      </div>
    </div>
  </q-page>
